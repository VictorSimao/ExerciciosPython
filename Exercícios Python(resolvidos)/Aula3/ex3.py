...
numeroregistro = input('Digite seu número de registro: ')
...
elif salario > 2826.65 and salario <= 4664.68:
    irrf = (((salario-inss)*0.225)-636.13)

elif salario > 4664.68:
    irrf = (((salario-inss)*0.227)-869.36)

salarioliquido = salario-inss-irrf

print(f'\nNome: {nome}\nCPF: {cpf}\nNúmero de Registro: {numeroregistro}\nCargo: {cargo}')
print(f'Salário Líquido: {salarioliquido} | Desconto de INSS: {inss} | Desconto IRRF: {irrf}')