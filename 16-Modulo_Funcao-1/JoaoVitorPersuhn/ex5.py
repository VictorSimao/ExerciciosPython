...
def calculaRaiz(indice : int, valorCalcular : int):
    return valorCalcular ** (1/indice)

indice = int(input('Digite o indice da raiz: '))
valor = int(input('Digite o valor a ser calculado: '))
resultado = calculaRaiz(indice, valor)

print(f'O valor da raiz de indice {indice} do numero {valor} é {resultado}')