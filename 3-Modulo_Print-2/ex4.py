...
telegram = False
print(f'\nNome: {nome}')
print(f'Possuo conta no Linkedin. Essa afirmação é {linkedin}')
print(f'Possuo conta no Instagram. Essa afirmação é {instagram}')
print(f'Possuo conta no Facebook. Essa afirmação é {facebook}')
print(f'Possuo conta no Telegram. Essa afirmação é {telegram}')