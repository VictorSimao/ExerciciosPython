...
#--- Crie uma variável de nome instagram e atribua um valor booleano 
...
print(f'Nome: {nome}, possuo linkedin {linkedin}, possuo instagram {instagram}, possuo facebook {facebook}, possuo telegram {telegram}')
