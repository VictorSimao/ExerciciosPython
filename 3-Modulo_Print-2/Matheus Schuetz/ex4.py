...
print(f'O usuario {nome}')
print(f'Possui conta no Linkedin?{linkedin}')
print(f'Possui conta no Instagram?{instagram}')
print(f'Possui conta no facebook?{facebook}')
print(f'Possui conta no telegram?{telegram}')