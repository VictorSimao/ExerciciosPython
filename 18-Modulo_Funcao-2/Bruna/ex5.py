...
print('--'*50)
print('Digite 0 para Logoff\nDigite 1 para cadastrar novo usuario\nDigite 2 para listar usuarios já cadastrados')
print('--'*50)
def menu(opcao):
    if opcao == 0:
        res = print('Usuário realizou o logoff')
    elif opcao == 1:
        res = print('Cadastro de usuários')
    elif opcao == 2:
       res = print('Lista de usuários cadastrados')
    else:
